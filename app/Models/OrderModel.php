...
class OrderModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    ...
    protected $allowedFields = ['business_id','table_id','status'];
