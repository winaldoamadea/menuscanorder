...
class ProductModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    protected $table = 'product'; // Specifies the database table that this model should interact with.
    ...
    protected $allowedFields = ['category_id','menu_id','name','description', 'price','image'];
