                ...
                <div class="col-md-6 p-0 order-md-2" style="height:60%">
                    <div class="card bg-dark text-white" style="border-radius: 1rem; height: 100vh;">
                        <div class="card-body p-5">
                            ...
                            <p class="text-white-50 mb-5">Please enter your business name and tables</p>
                            <form id="businessForm"> <!-- Changed the form ID to match the JavaScript -->
                                <div class="mb-4">
                                    <label class="form-label text-white">Business Name</label>
                                    <input class="form-control form-control-lg" name="name"> <!-- Added name attribute for the business name input -->
                                </div>
                                <div class="mb-4">
                                    <label class="form-label text-white">Tables</label>
                                    <input class="form-control form-control-lg" name="table">
                                    <input type="hidden" class="form-control form-control-lg" name=""> <!-- Added name attribute for the tables input -->
                                </div>
                                ...
                                <button id="saveBusiness" class="btn btn-outline-light btn-lg btn-custom ms-3" type="submit">Submit</button> <!-- Changed the button ID and added type submit -->
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
        document.getElementById('saveBusiness').addEventListener('click', function(event) {
            ...
            // Handle the successful response
                ...
                window.location.href = '<?= base_url("register-menu-name"); ?>/' + <?= $user['id']; ?>;
            })
            .catch(error => {
